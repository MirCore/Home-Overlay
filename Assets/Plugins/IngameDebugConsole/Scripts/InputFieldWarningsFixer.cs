...
namespace IngameDebugConsole
{
	...
	{
#if UNITY_2022_1_OR_NEWER && UNITY_EDITOR
		private static readonly FieldInfo preventFontCallback = typeof( TMPro.TMP_InputField ).GetField( "m_PreventFontCallback", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance );
